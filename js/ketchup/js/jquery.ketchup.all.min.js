...
jQuery.ketchup.validation("required", "Campo Obligatorio.", function (g, b, c) {
...
}).validation("number", "Campo Numerico.", function (g, b, c) {
    return this.isNumber(c)
}).validation("digits", "Must be digits.", function (g, b, c) {
    return /^\d+$/.test(c)
}).validation("email", "Se requiere un E-Mail valido.", function (g, b, c) {
    return this.isEmail(c)
}).validation("url", "Must be a valid URL.", function (g, b, c) {
    return this.isUrl(c)
}).validation("username", "No se aceptan Ciertos Caracteres.", function (g, b, c) {
