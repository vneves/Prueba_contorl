...
$APP['site_url'] = 'www.informaticalatina.com';

$APP['smith_url'] = 'http://'.$_SERVER['HTTP_HOST'].'/smith/';
$smithPath = "/home/dev_ilatina/dev.informaticalatina.com/smith/";
$includePath = '.:/home/dev_ilatina/dev.informaticalatina.com/smith/';
$dbUser = 'dev_ilatina';
$dbPassword = 'DESARROLLADORilatina';
//$dbHost = 'localhost';
$dbHost = 'mysql.dev.informaticalatina.com';
$dbDatabase = 'controlex_db';
$dbDriver = 'mysql';

$APP['base_url'] = 'http://'.$_SERVER['HTTP_HOST'].'/control/';
$APP['base_path'] = '/home/dev_ilatina/dev.informaticalatina.com/control/';
$APP['base_admin_path'] = '/home/dev_ilatina/dev.informaticalatina.com/control/webcamaleon/';
...
//
//$APP['smith_url'] = 'http://'.$_SERVER['HTTP_HOST'].'/smith/';
//$smithPath = "/var/www/smith/";
//$includePath = '.:/var/www/smith/';
//$dbUser = 'root';
//$dbPassword = 'ilatina';
//$dbHost = 'localhost';
////$dbHost = 'mysql.informaticalatina.com';
//$dbDatabase = 'control_db';
//$dbDriver = 'mysql';
//
//$APP['base_url'] = 'http://'.$_SERVER['HTTP_HOST'].'/control/';
//$APP['base_path'] = '/var/www/control/';
//$APP['base_admin_path'] = '/var/www/control/webcamaleon/';
...
//
//$APP['informacion']="130";
//$APP['Mapa Del Sitio']="141";
//$APP['Aguas']="144";
//$APP['Carbonatadas']="145";
//$APP['politica']="157";
//$APP['termino']="158";
//$APP['topslider']="159";
//-----------DEL NORTE------------------
...
$emailConfig = array(
	...
	"to" => 'info@salonsanmiguel.com; alyarof@gmail.com; ajimenez@ilatina.com',
	"subject" => 'Formulario de contacto',
	"reply" => '',
	"sender" => 'Sitio Web - Contacto',
	'extra_headers' => 'MIME-Version: 1.0' . "\n".
