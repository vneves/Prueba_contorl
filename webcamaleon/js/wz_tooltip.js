...
var ttBgColor     = "#EDEDED";
var ttBgImg       = "";           // path to background image;
//var ttBorderColor = "#003399";
//var ttBorderColor = "#0253b8";
var ttBorderColor = "#99CC33";
var ttBorderWidth = 1;
var ttClickClose  = false;
var ttDelay       = 150;          // time span until tooltip shows up [milliseconds]
var ttFontColor   = "#757575";
...
function tt_Htm(tt, t_id, txt)
{
	...
	if(t_tit)
	{
		t_y += '<tr><td style="padding-left:10px;padding-top:5px;padding-bottom:5px;padding-right:5px;background-color:#0099FF;" align="'+t_algn+'"><font color="'+t_titc+'" face="'+t_ff+'" ' +
