		...
		<tr>
			...
			?>
				<td valign="top">
                    ...
                    <tr>
						<td valign="top">&bull;&nbsp;</td>
						<td><strong>imagenes</strong> - Se usar&aacute; para formar la galer&iacute;a de im&aacute;genes de los productos.<br />							 
						</td>
					</tr>
                    <tr>
						<td valign="top">&bull;&nbsp;</td>
						<td><strong>contenido</strong> - Se mostrar&aacute; como imagen adjunta del contenido mostrado en las p&aacute;ginas.<br />
							 Su tama&ntilde;o debe ser de 400px de ancho.
						</td>
					</tr>
                    <tr>
						<td valign="top">&bull;&nbsp;</td>
						<td><strong>swf</strong> - Se usar&aacute; para formar la galer&iacute;a, si existe un tag "swf" se dara preferencia y las imagenes y la paginaci&oacute;n no se monstraran.<br />
						</td>
					</tr>
                    <tr>
						<td valign="top">&bull;&nbsp;</td>
                    ...
                    <tr>
						<td valign="top">&bull;&nbsp;</td>
						<td><strong>content_text</strong> - Se usar&aacute; como imagen adjunta al texto de la p&aacute;gina.<br />
						</td>
					</tr>
					</table>
				</td>
